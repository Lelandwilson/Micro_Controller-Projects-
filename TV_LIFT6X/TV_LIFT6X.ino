...
int B_Set_Up_timersetting = 60;  //UP max Travel time for lifter
...
//  unsigned long UpRun_t =millis()- runUPTime; 
//  //unsigned long UpRun_t = millis(); 
//  timer1 = B_Set_Up_timersetting*1000;
//  Serial.println("Travel timeout: "+ String(timer1));
//  if ((timer1) >= UpRun_t){
//    R_Dwn_on = false; // Ensure Both relays do not run at same time
...
//  unsigned long DwnRun_t =millis()- runDwnTime; //
//  timer1 = B_Set_Dwn_timersetting*1000;
//  Serial.println("Travel timeout: "+ String(timer1));
//  if ((timer1) >= DwnRun_t){
//    R_Up_on = false; // Ensure Both relays do not run at same time
//    Serial.println("Dwn Relay ON");
//    digitalWrite(R_Dwn, HIGH);
//    digitalWrite(ledPin, HIGH);
//    lastdirection = 0;  // 1 for up 0 for down, -1 for error
//    while (limit_TVdown == false){
...
//          Serial.println("Lifter is fully retracted");
//          limit_TVdown = true; //LID is fully retracted
//          Serial.println("Dwn Relay OFF");
//          digitalWrite(R_Dwn, LOW);
//          digitalWrite(ledPin, LOW);
//          R_Dwn_on = false;
//          }
...
//  // UP time load //
//  File UP_file = SPIFFS.open("/Uptime.txt");
//  while(UP_file.available()){
//    Load_Up_time +=char(UP_file.read());
//  }
//  UP_file.close();
//
//
//  // DWN time load //
//  File DWN_file = SPIFFS.open("/Dwntime.txt");
//  while(DWN_file.available()){
//    Load_Dwn_time +=char(DWN_file.read());
//  }
//  DWN_file.close();

//
//    // IR_code1 load //
//  File IR_code1_file = SPIFFS.open("/IR_code1.txt");
//  while(IR_code1_file.available()){
//    Load_IR_code1 +=char(IR_code1_file.read());
//    IR_code1 =  Load_IR_code1.toInt();
//  }
//  IR_code1_file.close();
//
//    // IR_code2 load //
//  File IR_code2_file = SPIFFS.open("/IR_code2.txt");
//  while(IR_code2_file.available()){
//    Load_IR_code2 +=char(IR_code2_file.read());
//    IR_code2 =  Load_IR_code2.toInt();
//  }
//  IR_code2_file.close();
  
//  Load_Settings += Load_Up_time;
//  Load_Settings += ", ";
//  Load_Settings += Load_Dwn_time;
//  Load_Settings += ", ";
//  Load_Settings += Load_IR_code1;
//  Load_Settings += ", ";
//  Load_Settings += Load_IR_code2;
  
  Serial.print("Loaded: [");
  Serial.print(Load_Settings);
  Serial.println("]");

//  UPinterval = Load_Up_time.toFloat();
//  DWNinterval = Load_Dwn_time.toFloat();
  
//  B_Set_Up_timersetting = UPinterval/1000;
//  //B_Set_Up_timersetting = UPinterval;
//  Serial.print("Up Timer set for ");
//  Serial.print(B_Set_Up_timersetting);
//  Serial.println(" seconds"); 
//
//  B_Set_Dwn_timersetting = DWNinterval/1000;
//  //B_Set_Dwn_timersetting = DWNinterval;
//  Serial.print("Dwn Timer set for ");
