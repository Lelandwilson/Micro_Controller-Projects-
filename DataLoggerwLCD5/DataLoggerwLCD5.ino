int cs =  53;
int dc =  47;  //RS Pin TFT
int rst = 48;  // you can also connect this to the Arduino reset
...
int ledState = HIGH;        
int but1State = 0;  
int mainDelay = 30000;   ///////////////MAIN DELAY TIME SETTING
...
//  if (dataFile != SD.open("datalog.csv", FILE_WRITE))
  ...
  if (! dataFile) 
  {
    ...
    // don't do anything more:
    //while (1) ;
  delay(30000);  // Allow time for card to be inserted
}
  printDate();
  Sensor();
  ...
  //lcd.print(Sval1,0);
  //lcd.print(",");
  dataFile.print(Sval1);
  dataFile.print(", ");
  Serial.print (Sval2);
  Serial.print (", ");
  //lcd.print(Sval2,0);
  //lcd.print(",");
  dataFile.print(Sval2);
  dataFile.print(", ");
  Serial.print (Sval3);
  Serial.print (", ");
  //lcd.print(Sval3,0);
  //lcd.print(",");
  dataFile.print(Sval3);
  dataFile.print(",");
  Serial.print (Sval4);
  Serial.print (", ");
  //lcd.print(Sval4,0);
  //lcd.print(",");
  dataFile.print(Sval4);
  dataFile.print(", ");
  Serial.print (Sval5);
  Serial.print (", ");
  //lcd.print(Sval5,0);
  //  //lcd.print(",");
  dataFile.print(Sval5);
  dataFile.print(",");
  Serial.print (Sval6);
  Serial.print (", ");
  //lcd.setCursor(0,1);
  //lcd.print(Sval6,0);
  //lcd.print(",");
  dataFile.print(Sval6);
  dataFile.print(", ");
  Serial.print (Sval7);
  Serial.print (", ");
  //lcd.print(Sval7,0);
  //lcd.print(","); 
  dataFile.print(Sval7);
  dataFile.print(", ");
  Serial.print (Sval8);
  Serial.print (", ");
  //lcd.print(Sval8,0);
  //lcd.print(",");
  dataFile.print(Sval8);
  dataFile.print(", ");
  Serial.print (Sval9);
  Serial.print (", ");
  //lcd.print(Sval9,0);
  //lcd.print(",");
  dataFile.print(Sval9);
  dataFile.print(",");
  Serial.print (Sval10);
  Serial.print (", ");
  //lcd.print(Sval10,0);
  //lcd.print(",");
  dataFile.print(Sval10);
  dataFile.print(",");
  Serial.print (Sval11);
  Serial.print (", ");
  //lcd.print(Sval11,0);
  //lcd.print(",");
  dataFile.print(Sval11);
  dataFile.print(",");
  Serial.print (Sval12);
  Serial.print (", ");
  //lcd.print(Sval12,0);
  //lcd.print(",");
  dataFile.print(Sval12);////////end of 12
  dataFile.print(",");
  Serial.print (Sval13);
  Serial.print (", ");
  //lcd.print(Sval13,0);
  //lcd.print(",");
  dataFile.print(Sval13);
  dataFile.print(",");
  Serial.println (Sval14);
  //lcd.println(Sval14,0);
  dataFile.println(Sval14);
