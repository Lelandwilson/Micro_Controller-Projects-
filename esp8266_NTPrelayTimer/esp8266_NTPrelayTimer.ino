...
String Ontime = "19:0:0";
String Offtime = "23:0:0";
...
void ICACHE_RAM_ATTR TimerHandler(){
  ...
  if (secondX>59){
    ...
    String CompareTime = String(hourX)+":"+String(minuteX)+":"+String(secondX);
...
//#if (TIMER_INTERRUPT_DEBUG > 0)  // Only prints when Debug is on
...
void setup() {
  ///////-----interrupt------///////
  // Interval in microsecs for interrupt
