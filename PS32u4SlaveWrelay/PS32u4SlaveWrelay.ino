...
const char* password = "WIFIPASSWORD HERE";
...
void Wait_receive()
{
  ...
  if (rf95.recv(buf, &len))
  {
    ...
    if (Test.substring(0,2) == "AA" && Test.substring(4,5) == "<" ) {
      //Serial.println("We got an A");
      Serial.print((char*)buf); //Received string
      Serial.print(rf95.lastRssi(), DEC);   //Signal strength
      Serial.println(">");
    } 

    if (Test.substring(0,2) == "RR" && Test.substring(4,5) == ":" ) {
